...
# Deploy Test Tokens Script
# This script deploys real ERC20 tokens for testing
...
print_header "🪙 DEPLOYING TEST TOKENS"
print_status "Deploying real ERC20 tokens for testing..."

# Create simple ERC20 token contract
...
print_success "Test token contract created"

# Deploy test tokens
print_status "Deploying test tokens..."

# USDC (6 decimals)
print_status "Deploying USDC token..."
USDC_ADDRESS=$(forge create contracts/TestToken.sol:TestToken \
...
WETH_ADDRESS=$(forge create contracts/TestToken.sol:TestToken \
...
DAI_ADDRESS=$(forge create contracts/TestToken.sol:TestToken \
...
WBTC_ADDRESS=$(forge create contracts/TestToken.sol:TestToken \
